...
('prof_SQelly@usp.br', 'SQLÉMUITOLEGAL', 12332, '547814320', NULL, 'SQELLY Rosa', 'SQELLY', 'Rosa'),
...
INSERT INTO curso (nome, modalidade, periodo, carga_horaria,id_instituto) VALUES
-- IME (Instituto de Matemática e Estatística)
('Bacharelado em Estatística', 'presencial', 'integral', 3600,1),
('Bacharelado em Matemática Pura', 'presencial', 'matutino', 4000,1),
('Bacharelado em Matemática Aplicada', 'presencial', 'integral', 4000,1),
('Bacharelado em Matemática Aplicada e Computacional', 'presencial', 'noturno', 4000,1),
('Bacharelado em Ciência da Computação', 'presencial', 'integral', 3800,1),

-- FEA (Faculdade de Economia, Administração e Contabilidade)
('Bacharelado em Economia', 'presencial', 'matutino', 4000,2), --- Ciências Econômicas 
('Bacharelado em Administração', 'presencial', 'noturno', 3800,2),
('Bacharelado em Ciências Contábeis', 'presencial', 'noturno', 3600,2),

-- FAU (Faculdade de Arquitetura e Urbanismo)
('Bacharelado em Arquitetura e Urbanismo', 'presencial', 'integral', 4200,3),
('Design', 'presencial', 'noturno', 3800,3),

-- IF (Instituto de Física)
('Bacharelado em Física', 'presencial', 'integral', 4000,4),
('Licenciatura em Física', 'presencial', 'noturno', 3600,4),
('Bacharelado em Física', 'presencial', 'noturno', 3800,4),

-- IAG (Instituto de Astronomia, Geofísica e Ciências Atmosféricas)
('Bacharelado em Astronomia', 'presencial', 'matutino', 4000,5),
('Bacharelado em Geofísica', 'presencial', 'integral', 3800,5),
('Bacharelado em Meteorologia', 'presencial', 'matutino', 3800,5),

-- IO (Instituto Oceanográfico)
('Bacharelado em Oceanografia', 'presencial', 'integral', 4000,6),
('Bacharelado em Oceanografia', 'presencial', 'noturno', 3600,6),

-- ECA (Escola de Comunicações e Artes)
('Bacharelado em Jornalismo', 'presencial', 'matutino', 3600,7),
('Bacharelado em Publicidade e Propaganda', 'presencial', 'integral', 3800,7);
...
--- Código para gerar a distribuição aleatória de alunos
...
--- Comando para inserção aleatória de 65 monitores 
...
INSERT INTO monitor (nusp_aluno) VALUES
(12141181),
(25191164),
(61289677),
(80633766),
...
DROP TABLE IF EXISTS avaliacao_monitor CASCADE;
...
INSERT INTO avaliacao_monitor (nota, comentario, nusp_aluno, nusp_monitor, time_stamp) VALUES
-- Avaliação 1 (Cálculo)
(9.8, 'Ele me ajudou em **Cálculo** a entender o Teorema Fundamental. Senti a evolução do aprendizado em um ritmo não-linear!', 82341752, 31417471, CURRENT_TIMESTAMP),
-- Avaliação 2 (Probabilidade)
(10.0, 'Monitora nota 10! Em **Probabilidade**, fez a variável aleatória da minha nota pular para o lado direito da curva normal.', 85656890, 52238771, CURRENT_TIMESTAMP),
-- Avaliação 3 (Álgebra Linear)
(7.5, 'Quando eu estava travado em **Álgebra Linear**, ele foi razoável. O problema foi resolvido, mas a explicação sobre autovalores poderia ter sido mais simples.', 64922718, 51965656, CURRENT_TIMESTAMP),
-- Avaliação 4 (Python)
(9.5, 'Monitoria excelente para **Python**. Meu código estava com um erro que nem o Stack Overflow resolvia. Ele achou o *bug* em 5 minutos.', 19999580, 56118633, CURRENT_TIMESTAMP),
-- Avaliação 5 (Geografia)
(8.0, 'Ela me deu suporte em **Geografia**. Passou umas referências boas sobre cartografia histórica, mas marcou 10 minutos de atraso.', 22539938, 90368490, CURRENT_TIMESTAMP),
-- Avaliação 6 (História)
(6.9, 'Monitor de **História** com bom conteúdo, mas a explicação da Revolução Francesa foi um pouco cansativa. Não rolou muita interação.', 52238771, 19124651, CURRENT_TIMESTAMP),
-- Avaliação 7 (Filosofia)
(9.9, 'Monitor em **Filosofia** incrivelmente paciente. Não tem como avaliar com menos que 9.9 depois de me guiar pela ética de Kant.', 54703534, 45235956, CURRENT_TIMESTAMP),
-- Avaliação 8 (Química)
(10.0, 'A melhor monitora de **Química** que já tive! Ela é um reagente perfeito para o aprendizado. A matéria simplesmente encaixou.', 21582456, 80633766, CURRENT_TIMESTAMP),
-- Avaliação 9 (Ondas e Mar)
(7.0, 'Em **Ondas e Mar**, as dicas de como calcular a frequência foram ótimas. Não dou nota maior porque ele atendeu o celular rapidamente.', 65239690, 52322019, CURRENT_TIMESTAMP),
-- Avaliação 10 (Cálculo)
(9.2, 'A monitora de **Cálculo** me deu exercícios extras. Foi punk, mas entendi a regra da cadeia de uma vez por todas. Recomendo!', 97824087, 56893610, CURRENT_TIMESTAMP),
-- Avaliação 11 (Probabilidade)
(8.5, 'Estava perdido em **Probabilidade** (aquela parte de eventos independentes). O monitor me fez refazer o cálculo até pegar a lógica.', 11704071, 41582912, CURRENT_TIMESTAMP),
-- Avaliação 12 (Álgebra Linear)
(8.8, 'Monitoria ok para **Álgebra Linear**. Me mostrou como diagonalizar a matriz, o que resolveu o problema, mas a aula foi bem direta ao ponto.', 44174777, 56760455, CURRENT_TIMESTAMP),
-- Avaliação 13 (Python)
(9.0, 'O monitor de **Python** conseguiu simplificar a herança de classes. Parece que ele lê meus pensamentos. Nota merecida.', 20643133, 10541896, CURRENT_TIMESTAMP),
-- Avaliação 14 (Geografia)
(6.5, 'Precisava de ajuda em **Geografia** política. O monitor deu umas referências, mas o foco dele estava meio disperso. Foi útil, mas poderia ser melhor.', 87107274, 12141181, CURRENT_TIMESTAMP),
-- Avaliação 15 (História)
(9.7, 'Monitora de **História** fantástica. Ela faz as conexões entre os fatos parecerem óbvias. Nota alta pela profundidade da discussão.', 20820890, 58318005, CURRENT_TIMESTAMP),
-- Avaliação 16 (Filosofia)
(7.9, 'O monitor de **Filosofia** me fez ler um texto chato, mas no final, a ideia de Platão ficou clara. Foi um aprendizado forçado, mas valeu a pena.', 58860446, 90787136, CURRENT_TIMESTAMP),
-- Avaliação 17 (Química)
(9.1, 'A monitoria de **Química** dela foi excelente! Ela desenha as moléculas de um jeito que não tem erro. Entendi a polaridade rapidinho.', 52216001, 84175446, CURRENT_TIMESTAMP),
-- Avaliação 18 (Ondas e Mar)
(9.6, 'Monitoria sobre **Ondas e Mar** que tirou todas as minhas dúvidas sobre refração e difração. Ele usa analogias ótimas!', 19635683, 61289677, CURRENT_TIMESTAMP),
-- Avaliação 19 (Cálculo)
(9.4, 'Minha monitora de **Cálculo** é a melhor. Ela não apenas resolve, mas te ensina a pensar como o Newton! Profissionalismo total.', 89046935, 87173572, CURRENT_TIMESTAMP),
-- Avaliação 20 (Comentário Engraçado)
(8.2, 'Gostava muito do monitor, pena que não está mais entre nós ... Foi morar na Bahia', 19124651, 45535528, CURRENT_TIMESTAMP);
...
/*
--- Comando utilizado para aleatorização 
DO $$
DECLARE
    num INTEGER;
    bloco VARCHAR(6);
...
*/
INSERT INTO associado (sala, num, bloco, nusp_usuario) VALUES
('C553', 553, 'C', 0),
('C503', 503, 'C', 1),
('A992', 992, 'A', 2),
('C915', 915, 'C', 3),
...
INSERT INTO avaliacao_professor (nota, comentario, nusp_aluno, nusp_professor, time_stamp) VALUES
(10.0, 'Excelente professora, tão boa que se não por ela, nem existiria o Banco de Dados que possui esse comentário', 61289677, 12332, CURRENT_TIMESTAMP),
(7.8, 'A aula é ótima, mas a luz da sala é fraca. Fiquei com medo de derivar no escuro.', 25191164, 37166, CURRENT_TIMESTAMP),
(10.0, 'Incrível! Ele explicou Teoria dos Grafos usando memes. Aprendi e ri.', 65239690, 69340, CURRENT_TIMESTAMP),
(6.5, 'O professor é bacana, mas ele fala "tipo assim" a cada 3 segundos. Distrai.', 65030514, 86426, CURRENT_TIMESTAMP),
(8.9, 'Minha nota subiu mais rápido que o preço do dólar. Recomendo fortemente!', 87173572, 97531, CURRENT_TIMESTAMP),
(5.2, 'Ele corrigiu meu trabalho em 3 segundos. Acho que ele tem a manopla do infinito.', 45879926, 75851, CURRENT_TIMESTAMP),
(9.9, 'Se eu fosse um produto, daria 5 estrelas. O melhor em explicar Recursão.', 19296641, 20861, CURRENT_TIMESTAMP),
(4.0, 'A matéria é difícil, e ele usa slides de 2005. Quase voltei no tempo.', 90368490, 64204, CURRENT_TIMESTAMP),
(7.2, 'O curso me ensinou mais sobre procrastinação do que sobre vetores. Mas tá valendo.', 20258776, 90340, CURRENT_TIMESTAMP),
(9.1, 'Ele conseguiu explicar Eletromagnetismo sem eu dormir. Isso é uma conquista histórica!', 99617579, 64200, CURRENT_TIMESTAMP),
(8.0, 'A explicação foi sólida, mas o cheiro de café forte era muito intenso. Foi um misto de ódio e amor.', 51965656, 14821, CURRENT_TIMESTAMP),
(6.3, 'Achei o conteúdo um pouco *sus*... mas ele me passou na final.', 78351697, 20862, CURRENT_TIMESTAMP),
(9.3, 'Nota máxima pelo uso estratégico de piadas ruins para nos manter acordados.', 89046935, 71847, CURRENT_TIMESTAMP),
(5.0, 'Achei que o professor ia resolver todos os meus problemas, mas ele só deu a fórmula (que não ajudou).', 50421191, 64206, CURRENT_TIMESTAMP),
(8.5, 'Ele trata a matéria como um *podcast* relaxante. Funcionou para mim.', 67118786, 64202, CURRENT_TIMESTAMP),
(7.7, 'A única coisa que entendi 100% foi a hora do intervalo. Mas o resto melhorou com o tempo.', 27335090, 42082, CURRENT_TIMESTAMP),
(10.0, 'Mestre! Ele não apenas ensina, ele desbloqueia a sua *skill* de programação.', 97472642, 73457, CURRENT_TIMESTAMP),
(9.6, 'A aula é uma montanha-russa de emoções. Complexa, mas no final, você quer ir de novo.', 27743327, 64208, CURRENT_TIMESTAMP),
(6.8, 'Achei que ele ia me dar um sermão quando perguntei a mesma coisa pela 5ª vez, mas ele foi paciente.', 49271026, 42079, CURRENT_TIMESTAMP),
(8.3, 'Meu cérebro doeu, mas foi um bom treino. Nota alta pelo esforço mútuo.', 26842492, 73085, CURRENT_TIMESTAMP);
...
-- tabela participa_em
DROP TABLE IF EXISTS participa_em CASCADE;


CREATE TABLE participa_em (
    nusp_aluno INTEGER NOT NULL,
    media_final NUMERIC(5,2) CHECK (media_final BETWEEN 0 AND 10),
...
CREATE TABLE grade (
    tipo_disciplina SMALLINT NOT NULL CHECK (tipo_disciplina IN (1,2)),
...
DROP TABLE IF EXISTS avaliacao_sala CASCADE;
CREATE TABLE avaliacao_sala (
    time_stamp TIMESTAMP NOT NULL,
    nota DECIMAL CHECK (nota BETWEEN 0 AND 10) NOT NULL,
    comentario VARCHAR(240) NOT NULL,
    nusp_avaliador INTEGER ,
...
INSERT INTO avaliacao_sala (time_stamp, nota, comentario, nusp_avaliador, id_sala, id_instituto)
SELECT NOW() - INTERVAL '60 minutes', 8.50, 'Quase perfeita! Só não é 10 porque a cadeira tentou me sequestrar 3 vezes. Recomendo!', 25, 'C5', 2
UNION ALL
SELECT NOW() - INTERVAL '59 minutes', 3.20, 'O projetor está se aposentando mais rápido que eu. Nota de 3,2 pela tentativa de ser útil.', 12, 'B58', 2
UNION ALL
SELECT NOW() - INTERVAL '58 minutes', 6.90, 'Nota justa. O ar condicionado é ótimo, mas a luz pisca como se estivesse mandando um código morse de socorro.', 54, 'B18', 2
UNION ALL
SELECT NOW() - INTERVAL '57 minutes', 9.10, 'Ambiente perfeito para pensar! Nota 10/10. O Wi-Fi é tão bom que consegui baixar 3 temporadas de memes em 2 segundos.', 79937489, 'B4', 2
UNION ALL
SELECT NOW() - INTERVAL '56 minutes', 4.50, 'O computador tem a velocidade de um caramujo pós-maratona. Precisa de upgrade urgente. Nota 4,5.', 42318353, 'A3', 4
UNION ALL
SELECT NOW() - INTERVAL '55 minutes', 7.70, 'Um bom lugar para codar. O único bug é a cadeira que range na hora mais silenciosa da aula.', 93463471, 'B7', 6
UNION ALL
SELECT NOW() - INTERVAL '54 minutes', 5.10, 'Nota 5,1. A única coisa que me fez ficar aqui foi o pão de queijo da cantina. O resto, na média.', 57388540, 'B29', 2
UNION ALL
SELECT NOW() - INTERVAL '53 minutes', 6.00, 'Se essa sala fosse uma comida, seria um miojo: cumpre a função, mas sem emoção. Nota 6,0.', 33, 'A3', 2
UNION ALL
SELECT NOW() - INTERVAL '52 minutes', 7.20, 'O Wi-Fi é forte o suficiente para eu procrastinar. Ponto positivo! (7,2)', 89199, 'B21', 1
UNION ALL
SELECT NOW() - INTERVAL '51 minutes', 1.50, 'O único calor aqui é o que eu sinto de raiva. O ar-condicionado é uma lenda. Nota de 1,5.', 31390160, 'B12', 3
UNION ALL
SELECT NOW() - INTERVAL '50 minutes', 8.80, 'Ótimo lugar. O silêncio me permitiu ouvir o grito do meu código em pânico. (8,8)', 0, 'B23', 1
UNION ALL
SELECT NOW() - INTERVAL '49 minutes', 5.50, 'A cadeira é a única coisa que me faz querer ir embora. O resto está na média.', 53192, 'C2', 7
UNION ALL
SELECT NOW() - INTERVAL '48 minutes', 9.50, 'Quase perfeita, faltou apenas um unicórnio mascote. Tirando isso, a melhor sala que já pisei!', 87352944, 'B29', 1
UNION ALL
SELECT NOW() - INTERVAL '47 minutes', 2.10, 'A porta emperra. É como tentar passar na prova de Cálculo 1. Nota baixa pela dificuldade.', 97905, 'B20', 1
UNION ALL
SELECT NOW() - INTERVAL '46 minutes', 6.70, 'O mouse travou no meio do meu projeto. Deu 6,7 pela tentativa. Tente de novo, sala!', 63703414, 'B42', 2
UNION ALL
SELECT NOW() - INTERVAL '45 minutes', 7.90, 'Passou no teste de conforto e funcionalidade. Faltou um botão de teletransporte. 7,9/10.', 56, 'A15', 2
UNION ALL
SELECT NOW() - INTERVAL '44 minutes', 5.80, 'A sala é tão neutra que até as paredes estão entediadas. Nota 5,8.', 14, 'B11', 2
UNION ALL
SELECT NOW() - INTERVAL '43 minutes', 4.00, 'Daria 10 se as mesas parassem de balançar. Parece que estão dançando um forró. Nota 4,0.', 11704071, 'B3', 3
UNION ALL
SELECT NOW() - INTERVAL '42 minutes', 6.10, 'Média na média. É como o arroz e feijão das salas de aula. Cumpre o papel.', 58318005, 'B10', 2
UNION ALL
SELECT NOW() - INTERVAL '41 minutes', 7.50, 'É um 7,5 sólido. Faria um 10 se a lousa fosse touchscreen.', 63896, 'B5', 2
UNION ALL
SELECT NOW() - INTERVAL '40 minutes', 9.80, 'Incrível! O único erro que encontrei nesta sala foi o meu código. 9,8!', 64200, 'A5', 4
UNION ALL
SELECT NOW() - INTERVAL '39 minutes', 5.30, 'O relógio de parede está parado na hora do almoço. Isso me deixou confuso. Nota 5,3.', 77, 'B17', 4
UNION ALL
SELECT NOW() - INTERVAL '38 minutes', 6.60, 'Falta de caneta no quadro. Tive que desenhar o diagrama de classes com o dedo. (Nota 6,6)', 31, 'C1', 2
UNION ALL
SELECT NOW() - INTERVAL '37 minutes', 8.10, 'Excelente. Só a lousa branca que parece ter sido usada para uma batalha de canetas de 1995.', 2, 'B6', 4
UNION ALL
SELECT NOW() - INTERVAL '36 minutes', 0.50, 'A sala é tão fria que jurei ter visto um pinguim lendo o código. Desliga o ar, por favor!', 65030514, 'B1', 4
UNION ALL
SELECT NOW() - INTERVAL '35 minutes', 7.00, 'É um 7. Não me surpreendeu, mas também não me decepcionou. O espelho da autoestima.', 48730862, 'B17', 3
UNION ALL
SELECT NOW() - INTERVAL '34 minutes', 8.90, 'Nota 9! Cuidado com o degrau imaginário na saída. Fora isso, impecável.', 75313, 'A6', 6
UNION ALL
SELECT NOW() - INTERVAL '33 minutes', 5.00, 'Sala que me faz sentir que estou em uma reunião de condomínio. Nota neutra: 5,0.', 66, 'B14', 2
UNION ALL
SELECT NOW() - INTERVAL '32 minutes', 3.50, 'Precisamos conversar sobre a tomada que se comporta como um adolescente: só funciona quando quer. Nota 3,5.', 43132003, 'C3', 5
UNION ALL
SELECT NOW() - INTERVAL '31 minutes', 7.30, 'O som ambiente de marteladas na rua desequilibra a nota, mas a sala em si é boa. 7,3.', 19078, 'B25', 1
UNION ALL
SELECT NOW() - INTERVAL '30 minutes', 6.40, 'Ambiente bom. Só o cheiro de pizza requentada de terça-feira que não ajuda na concentração. Nota 6,4.', 41498709, 'B9', 2
UNION ALL
SELECT NOW() - INTERVAL '29 minutes', 7.10, 'Boa iluminação e silêncio razoável. 7,1 de 10 porque não tem um café premium grátis.', 43624, 'A16', 2
UNION ALL
SELECT NOW() - INTERVAL '28 minutes', 10.00, 'NOTA 10! Não encontrei defeitos, nem mesmo os erros do meu código.', 8, 'A18', 2
UNION ALL
SELECT NOW() - INTERVAL '27 minutes', 4.80, 'O computador tem a velocidade de um caramujo pós-maratona. Precisa de upgrade. Nota 4,8.', 75312, 'B2', 4
UNION ALL
SELECT NOW() - INTERVAL '26 minutes', 6.80, 'O calor aqui me fez transpirar mais que um atleta. Mas a mesa é firme. Nota 6,8.', 83274986, 'B6', 5
UNION ALL
SELECT NOW() - INTERVAL '25 minutes', 2.50, 'A porta emperra. É como tentar passar na prova de Cálculo 1. Nota baixa pela dificuldade (2,5).', 95109678, 'B14', 6
UNION ALL
SELECT NOW() - INTERVAL '24 minutes', 5.60, 'O chão é pegajoso e minha meia não gostou disso. Nota 5,6.', 72335076, 'B53', 2
UNION ALL
SELECT NOW() - INTERVAL '23 minutes', 9.30, 'Excelente! Destaque para o silêncio que só é quebrado pela minha tosse.', 3, 'A2', 2
UNION ALL
SELECT NOW() - INTERVAL '22 minutes', 4.40, 'O interruptor de luz parece que foi desligado pela energia de um fantasma. Instável. Nota 4,4.', 31213864, 'B56', 2
UNION ALL
SELECT NOW() - INTERVAL '21 minutes', 8.30, 'É um 8,3. Não me surpreendeu, mas também não me decepcionou. O espelho da autoestima.', 99617579, 'A11', 2
UNION ALL
SELECT NOW() - INTERVAL '20 minutes', 6.20, 'O cheiro de limpeza é tão forte que sinto que minha alma está sendo desinfetada. Nota média.', 75959, 'B7', 7
UNION ALL
SELECT NOW() - INTERVAL '19 minutes', 7.80, 'Um 7,8 é o que você consegue quando a cadeira não te deixa com dor nas costas. Aprovada!', 84103422, 'A3', 5
UNION ALL
SELECT NOW() - INTERVAL '18 minutes', 5.70, 'O ar condicionado é ótimo, mas a luz pisca como se estivesse mandando um código morse de socorro. Nota 5,7.', 53816890, 'C3', 1
UNION ALL
SELECT NOW() - INTERVAL '17 minutes', 4.20, 'O computador é tão lento que parece que está processando os dados via pombo correio. Desastre!', 22539938, 'A4', 5
UNION ALL
SELECT NOW() - INTERVAL '16 minutes', 8.60, 'Bom lugar. Quase um 10. O problema é que eu estava no lugar da sala 42 e tive que mover o banco. (8,6)', 4, 'B21', 2
UNION ALL
SELECT NOW() - INTERVAL '15 minutes', 6.30, 'A sala é boa, mas o teclado tem mais migalhas do que um piquenique. Nota 6,3.', 97530, 'A19', 2
UNION ALL
SELECT NOW() - INTERVAL '14 minutes', 7.40, 'O projetor não explodiu e o Wi-Fi funcionou. Meus requisitos são baixos, então é um 7,4.', 39444895, 'B12', 5
UNION ALL
SELECT NOW() - INTERVAL '13 minutes', 1.00, 'O ar condicionado está quebrado e está 40 graus. Quase morri, por isso a nota baixa.', 52156, 'B65', 2
UNION ALL
SELECT NOW() - INTERVAL '12 minutes', 9.60, 'Ambiente perfeito para pensar, desde que o pensamento não exija energia elétrica (brincadeira, a tomada funcionou!).', 26842492, 'B1', 5
UNION ALL
SELECT NOW() - INTERVAL '11 minutes', 4.90, 'O único erro que encontrei nesta sala foi o meu código. A sala está ok, mas o estresse não. Nota 4,9.', 49018460, 'B32', 1
UNION ALL
SELECT NOW() - INTERVAL '10 minutes', 8.00, 'Nota 8. Só não é mais porque a cadeira rangeu e todo mundo me olhou.', 64205, 'B18', 5
UNION ALL
SELECT NOW() - INTERVAL '9 minutes', 7.60, 'A sala é boa, mas o teclado tem mais migalhas do que um piquenique. Nota 7,6.', 35, 'B5', 6
UNION ALL
SELECT NOW() - INTERVAL '8 minutes', 9.90, 'Nota 9,9. Só não é 10 porque a perfeição não existe. Sala incrível!', 97472642, 'A5', 2
UNION ALL
SELECT NOW() - INTERVAL '7 minutes', 3.80, 'O computador é tão lento que parece que está processando os dados via pombo correio. Desastre!', 29, 'C3', 2
UNION ALL
SELECT NOW() - INTERVAL '6 minutes', 6.50, 'É um 6,5 porque a cadeira é dura, mas o monitor é grande. Um empate técnico.', 20820890, 'B49', 2
UNION ALL
SELECT NOW() - INTERVAL '5 minutes', 1.90, 'O calor aqui me fez transpirar mais que um atleta. Mas a mesa é firme. Nota 1,9.', 52, 'C1', 7
UNION ALL
SELECT NOW() - INTERVAL '4 minutes', 8.40, 'Passou no teste de conforto e funcionalidade. Faltou um botão de teletransporte. 8,4/10.', 29276, 'B30', 1
UNION ALL
SELECT NOW() - INTERVAL '3 minutes', 7.00, 'O projetor não explodiu e o Wi-Fi funcionou. Meus requisitos são baixos, então é um 7,0.', 19, 'B45', 2
UNION ALL
SELECT NOW() - INTERVAL '2 minutes', 5.20, 'O cheiro de borracha queimada de vez em quando desequilibra. Nota 5,2.', 20862, 'B62', 2
UNION ALL
SELECT NOW(), 9.00, 'NOTA 9. A sala é tão fria que jurei ter visto um pinguim lendo o código.', 42084, 'B10', 3
UNION ALL
SELECT NOW(), 4.60, 'Daria 10 se as mesas parassem de balançar. Parece que estão dançando um forró. Nota 4,6.', 24342552, 'C2', 3
UNION ALL
SELECT NOW(), 8.20, 'Ambiente perfeito. Faltou apenas um unicórnio mascote. Tirando isso, a melhor sala que já pisei! (8,2)', 20056966, 'B10', 6
UNION ALL
SELECT NOW(), 3.40, 'O computador tem a velocidade de um caramujo pós-maratona. Precisa de upgrade urgente. Nota 3,4.', 85656890, 'B14', 7
UNION ALL
SELECT NOW(), 6.00, 'Se essa sala fosse uma comida, seria um miojo: cumpre a função, mas sem emoção. Nota 6,0.', 68379120, 'B11', 4
UNION ALL
SELECT NOW(), 7.00, 'É um 7. Não me surpreendeu, mas também não me decepcionou. O espelho da autoestima.', 99771717, 'B11', 7
UNION ALL 
SELECT NOW() ,8 , 'Ótima sala, pena que um ruivo alto fica sentado na minha frente sempre e não enxergo nada ', 99771717, 'B10', 1;
...
DROP TABLE IF EXISTS vinculo_trabalho CASCADE;
...
-- tabela coordenacao
DROP TABLE IF EXISTS coordenacao CASCADE; 
...
END $$;
-- tabela oferta_aula
DROP TABLE IF EXISTS oferta_aula CASCADE;
...
-- Preenchimento simplificado da tabela horario_aula
WITH ofertas_numeradas AS (
    SELECT
        id_oferta,
        sigla_disciplina,
        codigo_turma,
        vigencia,
        ROW_NUMBER() OVER (
            PARTITION BY sigla_disciplina, codigo_turma, vigencia
            ORDER BY id_oferta
        ) AS numero_oferta
    FROM
        oferta_aula
...
SELECT
    id_oferta,
    -- Alterna entre Segunda e Quarta para garantir dias diferentes
    CASE 
        WHEN numero_oferta = 1 THEN 'Segunda-feira'
        ELSE 'Quarta-feira'
    END AS dia_semana,
    -- Seleciona horário baseado em hash aleatório da turma
    CASE (ABS(HASHTEXT(sigla_disciplina || codigo_turma)) % 4)
    ...
    END AS hora_inicio,
    CASE (ABS(HASHTEXT(sigla_disciplina || codigo_turma)) % 4)
        WHEN 0 THEN '09:40:00'::TIME
        WHEN 1 THEN '11:40:00'::TIME
        WHEN 2 THEN '15:40:00'::TIME
        ELSE '17:40:00'::TIME
    END AS hora_fim
FROM
    ofertas_numeradas;
...
DROP TABLE IF EXISTS pedido_reserva CASCADE;
...
INSERT INTO pedido_reserva (proposito, horario_geracao, data_reserva, hora_inicio_reserva, hora_fim_reserva, status, timestamp_veredito, id_sala, id_instituto, nusp_solicitante, nusp_aprovador)
-- PENDENTES (Status 1) - nusp_aprovador NULL, timestamp_veredito NULL
SELECT 'Estudo intensivo para a prova de Cálculo 3, rezando para que a derivada ajude.', NOW(), (NOW() + INTERVAL '1 month')::DATE, '10:00:00'::TIME, '12:00:00'::TIME, 1, NULL::TIMESTAMP, 'B12', 1, 51965656, NULL::INTEGER
UNION ALL
SELECT 'Reunião do time de desenvolvimento de software para tentar convencer o código a funcionar.', NOW(), (NOW() + INTERVAL '1 month')::DATE, '14:00:00'::TIME, '16:00:00'::TIME, 1, NULL::TIMESTAMP, 'C2', 4, 11704071, NULL::INTEGER
UNION ALL
SELECT 'Prática de apresentação para o seminário de TCC. Preciso de uma sala com espelho.', NOW(), (NOW() + INTERVAL '1 month')::DATE, '16:00:00'::TIME, '18:00:00'::TIME, 1, NULL::TIMESTAMP, 'B6', 1, 42318353, NULL::INTEGER
UNION ALL
SELECT 'Sessão de brainstorming para um projeto de inovação (e encomendar pizza em paz).', NOW(), (NOW() + INTERVAL '1 month')::DATE, '09:00:00'::TIME, '11:00:00'::TIME, 1, NULL::TIMESTAMP, 'B18', 3, 58860446, NULL::INTEGER
UNION ALL
SELECT 'Workshop sobre "Como evitar que o PostgreSQL trave no seu projeto pessoal".', NOW(), (NOW() + INTERVAL '1 month')::DATE, '13:30:00'::TIME, '16:30:00'::TIME, 1, NULL::TIMESTAMP, 'B13', 7, 30878480, NULL::INTEGER
UNION ALL
-- APROVADOS (Status 2) - nusp_aprovador preenchido, timestamp_veredito preenchido
SELECT 'Simulação de um ataque de hackers (apenas para fins educacionais, prometo).', NOW() - INTERVAL '3 hours', (NOW() + INTERVAL '2 month')::DATE, '18:00:00'::TIME, '20:00:00'::TIME, 2, NOW() - INTERVAL '2 hours', 'B60', 2, 51608025, 15
UNION ALL
SELECT 'Preparação de slides para defesa de doutorado. Preciso de silêncio absoluto ou enlouqueço.', NOW() - INTERVAL '2 hours', (NOW() + INTERVAL '2 month')::DATE, '08:30:00'::TIME, '10:30:00'::TIME, 2, NOW() - INTERVAL '1 hour', 'B17', 4, 74527413, 35
UNION ALL
SELECT 'Maratona de debug: um esforço desesperado para encontrar aquele ponto e vírgula perdido.', NOW() - INTERVAL '1 hour', (NOW() + INTERVAL '2 month')::DATE, '11:00:00'::TIME, '13:00:00'::TIME, 2, NOW() - INTERVAL '30 minutes', 'B5', 1, 38151430, 5
UNION ALL
SELECT 'Sessão de leitura crítica de artigos sobre IA quântica.', NOW() - INTERVAL '4 hours', (NOW() + INTERVAL '2 month')::DATE, '15:00:00'::TIME, '17:00:00'::TIME, 2, NOW() - INTERVAL '2 hours', 'A5', 5, 17470481, 45
UNION ALL
SELECT 'Ensaio da banda do curso para o evento de final de semestre.', NOW() - INTERVAL '5 hours', (NOW() + INTERVAL '2 month')::DATE, '19:30:00'::TIME, '21:30:00'::TIME, 2, NOW() - INTERVAL '4 hours', 'B46', 2, 79877819, 15
UNION ALL
SELECT 'Estudo em grupo para Álgebra Linear. O determinante não vai se resolver sozinho.', NOW() - INTERVAL '10 hours', (NOW() + INTERVAL '3 month')::DATE, '07:00:00'::TIME, '09:00:00'::TIME, 2, NOW() - INTERVAL '8 hours', 'B16', 6, 81908514, 55
UNION ALL
SELECT 'Gravação de um podcast sobre a crise hídrica na programação orientada a objetos.', NOW() - INTERVAL '12 hours', (NOW() + INTERVAL '3 month')::DATE, '10:00:00'::TIME, '12:00:00'::TIME, 2, NOW() - INTERVAL '11 hours', 'B30', 1, 83274986, 5
UNION ALL
SELECT 'Aula particular de Cálculo com o monitor, esperando milagres.', NOW() - INTERVAL '15 hours', (NOW() + INTERVAL '3 month')::DATE, '13:00:00'::TIME, '15:00:00'::TIME, 2, NOW() - INTERVAL '14 hours', 'B4', 4, 61576014, 35
UNION ALL
SELECT 'Reunião para discutir a nova metodologia ágil: "O Dev que não chora, não codifica".', NOW() - INTERVAL '18 hours', (NOW() + INTERVAL '3 month')::DATE, '16:00:00'::TIME, '18:00:00'::TIME, 2, NOW() - INTERVAL '17 hours', 'B12', 1, 44174777, 5
UNION ALL
SELECT 'Festa surpresa (silenciosa e intelectual) para o aniversário do professor de BD.', NOW() - INTERVAL '20 hours', (NOW() + INTERVAL '3 month')::DATE, '18:03:00'::TIME, '20:00:00'::TIME, 2, NOW() - INTERVAL '19 hours', 'B26', 1, 19082867, 5
UNION ALL
SELECT 'Sessão de meditação para lidar com os erros de compilação da semana.', NOW() - INTERVAL '2 days', (NOW() + INTERVAL '4 month')::DATE, '09:30:00'::TIME, '10:30:00'::TIME, 2, NOW() - INTERVAL '1 day', 'B32', 1, 10541896, 5
UNION ALL
SELECT 'Preparação para um hackathon: preciso de uma sala que me abrace e me dê café.', NOW() - INTERVAL '3 days', (NOW() + INTERVAL '4 month')::DATE, '11:00:00'::TIME, '14:00:00'::TIME, 2, NOW() - INTERVAL '2 days', 'B11', 4, 45879926, 35
UNION ALL
SELECT 'Discussão sobre a filosofia do código limpo vs. código que funciona.', NOW() - INTERVAL '4 days', (NOW() + INTERVAL '4 month')::DATE, '14:30:00'::TIME, '16:30:00'::TIME, 2, NOW() - INTERVAL '3 days', 'C5', 2, 41498709, 15
UNION ALL
SELECT 'Simulação de entrevista técnica em inglês para a vaga de júnior.', NOW() - INTERVAL '5 days', (NOW() + INTERVAL '4 month')::DATE, '17:00:00'::TIME, '19:00:00'::TIME, 2, NOW() - INTERVAL '4 days', 'C2', 3, 32931158, 25
UNION ALL
SELECT 'Testes de usabilidade em um aplicativo de controle de sono. Necessário silêncio e conforto.', NOW() - INTERVAL '6 days', (NOW() + INTERVAL '4 month')::DATE, '19:00:00'::TIME, '21:00:00'::TIME, 2, NOW() - INTERVAL '5 days', 'B6', 1, 83631019, 5
UNION ALL
-- REPROVADOS (Status 3) - nusp_aprovador preenchido, timestamp_veredito preenchido
SELECT 'Ensaio de teatro experimental sobre a angústia existencial do programador.', NOW() - INTERVAL '7 days', (NOW() + INTERVAL '5 month')::DATE, '08:00:00'::TIME, '10:00:00'::TIME, 3, NOW() - INTERVAL '6 days', 'A5', 6, 61624345, 55
UNION ALL
SELECT 'Competição de velocidade de digitação (a máquina mais barulhenta ganha).', NOW() - INTERVAL '8 days', (NOW() + INTERVAL '5 month')::DATE, '10:30:00'::TIME, '12:30:00'::TIME, 3, NOW() - INTERVAL '7 days', 'B14', 3, 78394438, 25
UNION ALL
SELECT 'Reunião secreta do Clube do Café e da Procrastinação Estratégica.', NOW() - INTERVAL '9 days', (NOW() + INTERVAL '5 month')::DATE, '13:00:00'::TIME, '15:00:00'::TIME, 3, NOW() - INTERVAL '8 days', 'B20', 1, 25384999, 5
UNION ALL
SELECT 'Sessão de jogos de tabuleiro de alta estratégia para desenvolver habilidades de liderança.', NOW() - INTERVAL '10 days', (NOW() + INTERVAL '5 month')::DATE, '15:30:00'::TIME, '17:30:00'::TIME, 3, NOW() - INTERVAL '9 days', 'A4', 3, 40500206, 25
UNION ALL
SELECT 'Gravação de um vlog sobre a vida acadêmica e os mistérios da máquina de xerox.', NOW() - INTERVAL '11 days', (NOW() + INTERVAL '5 month')::DATE, '18:00:00'::TIME, '20:00:00'::TIME, 3, NOW() - INTERVAL '10 days', 'B29', 1, 11988484, 5;


-- tabela representa_disciplina
DROP TABLE IF EXISTS representa_disciplina CASCADE;
